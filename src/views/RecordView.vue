  ...
  <div id="q-app">
    <div class="q-layout q-layout--standard" style="min-height: 274px">
          ...
          <div class="record-header row justify-center">
            ...
            ><label
              ...
              class="
                ...
                q-select
                q-field--auto-height
                q-select--without-input q-select--without-chips q-select--single
                q-field--borderless q-field--float
      ...
      <div class="content list-content">
        <div class="row items-center justify-between q-mb-md lt-sm">
          <label
            for="f_8b976eae-6ab7-4231-b14f-3e8c7c05b688"
            class="
              q-field
              row
              no-wrap
              ...
              >
                ...
                >
                  <div class="q-field__native row items-center">
                    <span>默认分类</span>
                    <div
                      id="f_8b976eae-6ab7-4231-b14f-3e8c7c05b688"
                      tabindex="0"
                      role="combobox"
                      aria-multiselectable="false"
                      aria-expanded="false"
                      aria-owns="f_8b976eae-6ab7-4231-b14f-3e8c7c05b688_lb"
                      aria-activedescendant="f_8b976eae-6ab7-4231-b14f-3e8c7c05b688_-1"
                      class="no-outline"
                    ></div>
                  </div>
                </div>
        ...
        <div class="record-border color-divider color-bg-content">
          <label
            ...
            class="
              ...
              items-start
              record-text
              color-bg-content color-text
              q-textarea q-textarea--autogrow
              q-field--borderless
              q-validation-component
            "
        ...
        >
          <div class="row items-center">
            <div class="num-font color-desc q-mr-md">0 字</div>
            <hr
              role="separator"
            ...
            <label
              ...
              class="
                ...
                q-field--auto-height
                q-select--without-input q-select--without-chips q-select--single
                q-field--borderless q-field--float q-field--dense
                q-validation-component
              "
